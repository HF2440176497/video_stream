...
// in some situations, we need push meta depend on condition, refer to vp_split_node which would push meta by channel
// index or push a deep copy pf meta(new pointer to new memory).
